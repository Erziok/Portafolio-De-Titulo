...
@section('title') Agregar Sesiones @endsection
@section('content')
...
<div class="app-body-main-content">
    <div class="section-title mb-5 mt-2">    
        <h1 class="f-size-lg">Crear Sesiones del Curso</h1>
        <div class="hline"></div>
    </div>
    <div class="form-box">
        <form action="{{ route('admin.course.store-sessions') }}" method="POST" id="form-store-sessions">
            @csrf
...
@section('JS')
    <script src="{{ asset('js/course-calendar-create.js?v='.time()) }}"></script>
@endsection